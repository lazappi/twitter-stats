---
title: "Twitter coverage of the American Society of Human Genetics 68th Annual Meeting"
author: "Luke Zappia"
date: "`r Sys.time()`"
output: 
  html_document: 
...
hashtag <- "#ASHG18"
conf_name <- "American Society of Human Genetics 68th Annual Meeting"
...
params <- data.frame(Parameter = c("Hashtag", "Conference", "Time Zone", "Days",
                                   "Accent colour", "Pallete", "Topics k",
                                   "Fixed"))
params_list <- list(hashtag, conf_name, timezone, days, accent, pal, topics_k,
                    fixed)
